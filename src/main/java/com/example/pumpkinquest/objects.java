...
public class objects {
    ...
    public objects(frame mainFrame) {
        this.mainFrame = mainFrame;
    }

    public static void objects() {
        debugMode = mainFrame.debugMode;
    }
    ...
    */
    ...
    public static JLabel[] upAttack = new JLabel[]{
    ...
    private void initializeObjects() {
        press = mainFrame.GUIassets(125, 700, 760, 40, false, "images/GUI/pressE.png", false, 0, false);
        pressChest = mainFrame.GUIassets(125, 700, 760, 40, false, "images/GUI/pressE.png", false, 0, false);
        pressrespawn = mainFrame.GUIassets(75, 450, 860, 350, false, "images/text/respawn.png", false, 0, false);
        respawnSet = mainFrame.GUIassets(75, 0, 860, 350, false, "images/text/respawnSet.png", false, 0, false);
        iceSpikeOne = mainFrame.GUIassets(430, 345, 125, 125, false, "images/mob/tortles/iceSpikeSmall.png", false, 1, false);
        iceSpikeTwo = mainFrame.GUIassets(430, 345, 125, 125, false, "images/mob/tortles/iceSpikeBig.png", false, 1, false);
        gotApple = mainFrame.GUIassets(130, 600, 1280, 320, false, "images/text/appleFind.png", false, 0, false);
        armourFound = mainFrame.GUIassets(130, 600, 900, 320, false, "images/equipment/ArmourFound.png", false, 0, false);
        warp = mainFrame.assets(-1000, 1000, 100, 200, false, "images/assets/warpstone.png", false, 8, true);
        treebarrier = mainFrame.assets(2775, -5800, 590, 7500, mainFrame.debugMode, "images/assets/manymanytrees.png", false, 8, true);
        ...
        chestImages = new JLabel[]{
                mainFrame.assets(3880, -525, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(1708, -2861, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(6000, -465, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(10600, -495, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(15260, -1430, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(15240, -6200, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(3220, -7720, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(9090, -4200, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(14950, -3820, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(11345, -7470, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(3675, -7610, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(8600, -2470, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(15540, -6890, 150, 150, false, "images/assets/chest.png", false, 8, true),
                mainFrame.assets(4220, -7240, 150, 150, false, "images/assets/chest.png", false, 8, true)
        };
        ghost1 = mainFrame.mobCreation(2250, -3000, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost2 = mainFrame.mobCreation(2250, -3600, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost3 = mainFrame.mobCreation(2500, -4450, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost4 = mainFrame.mobCreation(2100, 5500, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost5 = mainFrame.mobCreation(2800, -6300, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost6 = mainFrame.mobCreation(4100, -6000, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost7 = mainFrame.mobCreation(4400, -5100, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost8 = mainFrame.mobCreation(4450, -4150, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost9 = mainFrame.mobCreation(5000, -2800, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost10 = mainFrame.mobCreation(4800, -2000, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost11 = mainFrame.mobCreation(4005, -2645, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        ghost12 = mainFrame.mobCreation(4085, -1700, 200, 200, "images/mob/ghostLeft.png", 2, 20, 0.5, 300, 3, 600, 1);
        slime1 = mainFrame.mobCreation(4685, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime2 = mainFrame.mobCreation(4810, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime3 = mainFrame.mobCreation(5105, -455, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime4 = mainFrame.mobCreation(5350, -555, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime5 = mainFrame.mobCreation(5560, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime6 = mainFrame.mobCreation(5750, -555, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime7 = mainFrame.mobCreation(4785, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime8 = mainFrame.mobCreation(4910, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime9 = mainFrame.mobCreation(5205, -455, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime10 = mainFrame.mobCreation(5450, -555, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime11 = mainFrame.mobCreation(5660, -655, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        deadEnd = mainFrame.mobCreation(13300, -6700, 200, 165, "", 2, 10, 3, 300, 5, 500, 1);
        zombie1 = mainFrame.mobCreation(7760, -880, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie2 = mainFrame.mobCreation(7430, -2070, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie3 = mainFrame.mobCreation(7570, -3130, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie4 = mainFrame.mobCreation(7920, -3870, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie5 = mainFrame.mobCreation(8000, -4910, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie6 = mainFrame.mobCreation(9120, -3770, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie7 = mainFrame.mobCreation(9090, -2850, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie8 = mainFrame.mobCreation(9200, -1950, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie9 = mainFrame.mobCreation(10070, -110, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        spider1 = mainFrame.mobCreation(15260, -1330, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider2 = mainFrame.mobCreation(15270, -2400, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider3 = mainFrame.mobCreation(15450, -3280, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider4 = mainFrame.mobCreation(15000, -4400, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider5 = mainFrame.mobCreation(15000, -6040, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider6 = mainFrame.mobCreation(15560, -6950, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider7 = mainFrame.mobCreation(15000, -6040, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider8 = mainFrame.mobCreation(15260, -5200, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        spider9 = mainFrame.mobCreation(11920, -7720, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        zombie10 = mainFrame.mobCreation(11020, -7040, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        ghost13 = mainFrame.mobCreation(9430, -6930, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 300, 3, 600, 1);
        slime12 = mainFrame.mobCreation(8820, -5770, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        slime13 = mainFrame.mobCreation(8570, -6250, 80, 65, "images/mob/littleslime.png", 2, 10, 0.5, 150, 5, 800, 1);
        spider10 = mainFrame.mobCreation(7510, -6450, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        ghost14 = mainFrame.mobCreation(6670, -7100, 200, 200, "images/mob/ghostRight.png", 2, 20, 0.5, 200, 5, 600, 1);
        zombie11 = mainFrame.mobCreation(5540, -7270, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie12 = mainFrame.mobCreation(4720, -7470, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        zombie13 = mainFrame.mobCreation(3650, -7590, 80, 160, "images/mob/zombie.png", 2, 50, 1, 200, 2, 1000, 2);
        spider11 = mainFrame.mobCreation(3640, -7590, 160, 80, "images/mob/spider.png", 2, 20, 0.5, 200, 5, 600, 1);
        tortles = mainFrame.mobCreation(21600, -2272, 200, 376, "images/mob/tortles/downStanding.png", 2, 1000, 1, 150, 3, 1600, 1);
        NPC = mainFrame.assets(2100, -2000, 100, 200, false, "images/NPC/Grandma/grandma.png", false, 2, true);
        NPC3 = mainFrame.assets(9200, -1600, 126, 238, false, "images/NPC/Maze/secondnpc.png", false, 2, true);
        NPC2 = mainFrame.assets(14450, -7100, 116, 228, false, "images/NPC/Wizard/wizard.png", false, 2, true);
        waterBarrier = mainFrame.assets(0, 900, 20000, 800, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier1 = mainFrame.assets(5400, -5875, 1975, 600, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier2 = mainFrame.assets(5200, -5225, 2175, 250, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier3 = mainFrame.assets(5000, -5475, 1550, 2000, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier4 = mainFrame.assets(5400, -3875, 1650, 2200, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier5 = mainFrame.assets(5600, -1875, 1550, 760, mainFrame.debugMode, "", false, 3, false);
        lakeBarrier6 = mainFrame.assets(6450, -4475, 700, 560, mainFrame.debugMode, "", false, 3, false);
        endScreen = mainFrame.GUIassets(0, 0, 1000, 1000, false, "images/GUI/gameOver.png", false, 2, false);
        escToQuit = mainFrame.GUIassets(100, 500, 800, 300, false, "images/GUI/escToQuit.png", false, 2, false);
        pumpkin = mainFrame.GUIassets(400, 100, 200, 200, false, "images/GUI/pumpkin.png", false, 2, false);
        controls = mainFrame.GUIassets(550, 50, 400, 600, false, "images/GUI/controls.png", false, 0, true);
        SScredits = mainFrame.GUIassets(0, 0, 1040, 780, false, "images/GUI/creditsScreen.png", false, 2, true);
        startMenu = mainFrame.GUIassets(0, 0, 1000, 1000, false, "images/GUI/placeHolderStart.png", false, 2, true);
        startCredits = mainFrame.GUIassets(100, 300, 400, 40, false, "images/GUI/startScreenCredits.png", false, 1, true);
        startPlay = mainFrame.GUIassets(100, 200, 400, 40, false, "images/GUI/startScreenNew.png", false, 1, true);
        startQuit = mainFrame.GUIassets(100, 400, 400, 40, false, "images/GUI/startScreenQuit.png", false, 1, true);
        currentSelection = mainFrame.GUIassets(25, 192, 60, 60, false, "images/GUI/selectionarrow.png", false, 1, true);
        NPCBackground = mainFrame.GUIassets(-170, 370, 1320, 500, false, "images/NPC/NPCDialogueBackground.png", false, 2, false);
        warpBack = mainFrame.assets(21553, -4705, 100, 200, false, "images/assets/warpStone.png", false, 8, true);
        warpArena = mainFrame.assets(2502, -7564, 100, 200, false, "images/assets/warpStone.png", false, 8, true);
        rockThird = mainFrame.assets(2500, 2500, 200, 200, false, "images/assets/rock.png", false, 8, true);
        Rock274736 = mainFrame.assets(2353, -7107, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock3320042 = mainFrame.assets(2278, -7257, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock2848022 = mainFrame.assets(2178, -7432, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock4690770 = mainFrame.assets(2178, -7557, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock8165025 = mainFrame.assets(2178, -7732, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock9260882 = mainFrame.assets(2178, -7832, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock2335392 = mainFrame.assets(2278, -7932, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock754881 = mainFrame.assets(2403, -8007, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock1726032 = mainFrame.assets(1577, -8031, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock8461454 = mainFrame.assets(1577, -7856, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
        Rock4868639 = mainFrame.assets(1577, -7681, 200, 200, mainFrame.debugMode, "images/assets/rock.png", false, 8, true);
    }
}
